...
def mergeRun(field_21,numField_21,fixDay,addPostfix='',needMerge=True,toffm=True):
    ...
    merge_train='../data/temp/merge_appID_userID_{fixDay}_isInstalled.csv'.format(fixDay=fixDay)
    merge_test='../data/temp/merge_test_appID_userID_{fixDay}_isInstalled.csv'.format(fixDay=fixDay)
...
if __name__=='__main__':
    ...
    mergeRun(field_21,numField_21,fixDay=190000,addPostfix='no_Dist_noNum_isInstalled',toffm=True)
