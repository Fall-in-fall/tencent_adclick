...
if __name__=="__main__":
    ...
    fieldListList=[['userID','appID'], ['userID'],['userID','appCategory'], ['userID','advertiserID']]
    fieldstr=','.join( [''.join(f) for f in fieldListList]  )
    field=getBaseField()
    ...
    dataPath='../data/temp/train_addRatio.csv'
    testData='../data/temp/test_addRatio.csv'
    ...
    pre2(trainFeatures,trainLabels,testFeatures,testIns,'xgb_{field}'.format(field=fieldstr),4000,0.08,5)
