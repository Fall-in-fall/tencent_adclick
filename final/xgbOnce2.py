...
if __name__=="__main__":
    ...
    pre2(trainFeatures,trainLabels,testFeatures,testIns,'xgb_{field}.csv'.format(field=fieldstr),5000,0.08,5)
    pre2(trainFeatures,trainLabels,testFeatures,testIns,'xgb_{field}.csv'.format(field=fieldstr),6000,0.08,5)
    pre2(trainFeatures,trainLabels,testFeatures,testIns,'xgb_{field}.csv'.format(field=fieldstr),7000,0.08,5)
